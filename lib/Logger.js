...
var Logger = /** @class */ (function () {
    ...
    Logger.prototype.log = function (level, message, e, pl) {
        ...
        if (payload) {
            var payloadType = payload.name;
            // convert to snake-case
            var data = decamelizeKeys(payload.data);
            // inject payload information
            var plTypeAttribute = 'payload_type';
            ...
            var payloadAttribute = this.context + " " + decamelize(payloadType);
